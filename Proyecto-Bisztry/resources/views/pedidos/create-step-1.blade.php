...
<div class="step-indicator">
    <div class="step step-active">
        ...
        <div class="step-label">1. Seleccionar Cliente</div>
    </div>
...
<div class="card max-w-3xl mx-auto mt-6">
    <div class="card-header">
        <h3><i class="fas fa-user-check text-primary mr-2"></i>Paso 1: ¿Para quién es el pedido?</h3>
    </div>
    <div class="card-body">
        <p class="text-secondary mb-4">
            Comienza seleccionando un cliente existente de tu base de datos. Puedes buscar por nombre o email para encontrarlo rápidamente.
        </p>
        <form action="{{ route('pedidos.create.step1.post') }}" method="POST">
            @csrf
            <div class="form-group">
                <label for="clie_id">Buscar y seleccionar cliente *</label>
                {{-- Este desplegable será transformado por Select2 para añadir un buscador --}}
                <div wire:ignore>
...
.text-danger { font-size: 0.75rem; color: var(--danger-color); }
.btn-lg { padding: 0.8rem 1.75rem; font-size: 1rem; }
.form-actions { justify-content: flex-end; border-top: none; }
</style>
{{-- La línea @endpush que estaba aquí fue eliminada porque era incorrecta --}}
@endsection


@push('scripts')
<script>
    // Inicializamos Select2 en nuestro desplegable de clientes
